...
if(!empty($password1) && !empty($password2) && strlen($password1) >8 ){
if($password1==$password2){
     $pass = hash('md5', $password1);
           $query="UPDATE signup1 SET password='$pass' WHERE email='$email'";
  ...
  echo "<script>alert('Password length should be equal to 8 or more than it.');</script>";
}
}
?>
...
<div class="dropdown">
    ...
    <div class="login-box">
            ...
            <i class="fal fa-key icon fa-input"></i><input type="password" name="password1" placeholder="Enter Your Password">
          </div>
        </div>
        <div class="form-group">
            <div class="input-container">
            <i class="fal fa-key icon fa-input"></i><input type="password" name="password2" placeholder="Re-Enter Your Password">
          </div>
        </div>
        <div class="form-group">
