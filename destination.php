...
if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
    ...
    echo "<script>";
  echo "alert('Book Your Destination')";
     echo "</script>";
} else {
 echo "<script>
...
if(isset($_POST["book"]))
{
  ...
  $_SESSION['image']=$_POST["hidden_image"];
  header("Location: destination-single.php");
  }
 ?>
<!DOCTYPE html>
<html lang="en">
...
<style>
body{
    background-image: linear-gradient(rgb(0,0,0,0.5),rgb(0,0,0,0.5)),url(destination-single1.jpg);
...
<h1>Discover new palce</h1>
<q>The goal is to die with memories not dreams.</q><p id="writer">-Stephen Covey</p>
</section>
<br><br><br><br><br><br>
          ...
          <div class="col-sm-4">
            <div class="project">
              ...
              <div class="text-center">
                ...
                <h4 class="text-danger text-center">Rs. <?php echo $row["price"]; ?></h4>
